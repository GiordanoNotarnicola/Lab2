...
Directory='/home/studentelab2/dati_arduino/' # <<<<<< now looking at a file in the datifit directory
...
pylab.errorbar(x, y, yerr=Dy, fmt='.', label='Dati', color = 'black')
pylab.plot(xx,ff(xx,*pars), color='grey')
